...
(function (NativeActions) {
    ...
    NativeActions["clickThrough"] = "clickThrough";
...
var MobileAd = /** @class */ (function () {
    ...
    MobileAd.prototype.clickThrough = function (_a) {
        var x = _a.x, y = _a.y;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, execAsync(NativeActions.clickThrough, [{ x: x, y: y, id: this.id }])];
            });
        });
    };
    MobileAd.type = '';
...
var NativeAd = /** @class */ (function (_super) {
    ...
    NativeAd.prototype.clickThrough = function (_a) {
        var x = _a.x, y = _a.y;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, _super.prototype.clickThrough.call(this, { x: x, y: y })];
            });
        });
    };
